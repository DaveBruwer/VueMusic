<template>
    ...
    <vee-form :validation-schema="schema" @submit="login_login">
        <!-- Email -->
        <div class="mb-3">
            <label class="inline-block mb-2" for="login-email">Email
            <vee-field type="email" id="login-email" name="email"
        ...
        <!-- Password -->
        <div class="mb-3">
            <label class="inline-block mb-2" for="login-paswrd">Password
            <vee-field type="password" id="login-paswrd" name="password"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                duration-500 focus:outline-none focus:border-black rounded"
